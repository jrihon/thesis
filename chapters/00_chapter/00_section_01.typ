...
The dihedrals of the backbone follow the consecutive chain, which follow the 5_'_ $arrow.r$ 3_'_ direction and hence follow the Greek alphabet's lexicographical order, and are named from $alpha arrow.r zeta$ (@fig-iupacnames C.). 

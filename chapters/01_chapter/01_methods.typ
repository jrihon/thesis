...
These points are then converted into the Strauss-Pickett impromper dihedrals ($alpha_1$, $alpha_2$, $alpha_3$) and are used as constraints for the CS methodology (@fig-ConfSamplingExplained C.).
...
Queries of _pucke.rs_ and _pucke.py_ are given in (Suppl. Inf.).

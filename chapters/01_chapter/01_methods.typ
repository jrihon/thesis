...
Figures are made with Matplotlib and Cartopy. @fig-sixring B. details on the conventions used to define the CP six-membered ring space in relations to the mathematical convention of defining latitude-longitude coordinates, for graphical purposes.

...
The five-membered ring method return a 2D grid, returning sets of proper dihedrals to be used as constraints for GO procedures (Figure  \ref{fig:conf_sampling_explained}B.). 
...
This, however, does exactly align with the AS formalism #mcite(("Altona1972formalism"), biblio), instead of the Cremer-Pople formalism, as attributed by Cornell _et al._. 

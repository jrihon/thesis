...
Around a latitude of 55$degree$, we encounter the Envelope (#super("X")E, E#sub("Y")) and Twist (#super("X")T#sub("Y")) (example in @fig-InversionConf B.) puckering modes, while at 135$degree$ we see their inverse puckering modes (#super("Y")E, E#sub("X") ; #super("Y")T#sub("X")). Twists are often referred to as halfchairs and define a conformation where only two consecutive atoms both exist out-of-plane, one on either side of the plane. @fig-sixring gives an overview of five-membered ring pucker modes

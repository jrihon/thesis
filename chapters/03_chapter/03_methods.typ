...
At first, a conformational path through which the HNA chemistry could naturally move through was researched. Conformations were optimised using the ORCA computational chemistry package #mcite(("Neese2020ORCA"), biblio), employing the PBE0/ma-def2-svp method #mcite(("Adamo1999PBE0", "Zheng2010madef2"), biblio).  After having defined these pathways (@fig-pathway), a Nudged Elastic Band #mcite(("Asgeirsson2021NebTS"), biblio) protocol was applied to gather intermediary conformations between the established puckering modes. A total of 192 total conformations were fitted, meaning 48 distinct and intermediary conformations per nucleobase, to fit the behaviour of the HNA chemistry to the force field. The fit itself was done using the _Paramfit_ script, provided within AMBERTools #mcite(("Betz2014paramfit"), biblio).
]

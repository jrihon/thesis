...
Only subtle changes in dihedral angles of the RNA strand, compared to values measured in dsRNA A-type helices, are imposed by the complementary MNA. The significantly different helical parameters, like increased radius of the double helix and altered positioning of the phosphoramidate due to the morpholino ring, can all contribute to the lack of RNA degradation when bound to complementary MNA sequences. Except for a Watson-Crick-Franklin to Hoogsteen transition in a mA:U basepair, that was facilitated by K#super("+") binding and fraying at the helix end, stable WCF base pairing was observed during the MD simulation.

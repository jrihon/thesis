...
The unique chemistry of the MNA backbone changed orientation of the phosphoramidate in MNA and displaces the P atom in a position where it does not align with phosphates in the backbone of standard RNA (@fig-LinkerOrient). Combined with the significantly different helical parameters, like increased radius of the double helix, altered positioning of the phosphoramidate due to the morpholino ring, can all contribute to the lack of RNA degradation when bound to complementary MNA sequences #mcite(("Nan2018antisense"), biblio).   
